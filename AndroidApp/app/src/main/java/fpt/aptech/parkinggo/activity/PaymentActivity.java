...
public class PaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookingRes = (EPaymentRes) getIntent().getSerializableExtra("bookingRes");
        ArrayList book = (ArrayList) getIntent().getSerializableExtra("bookingReq");
    ...
    private void createZalopay(EPaymentRes bookingRes) {
        ZaloPaySDK.getInstance().payOrder(PaymentActivity.this, bookingRes.getSignature(), "parkinggo://app", new PayOrderListener() {
            @Override
...
//            tvMessage.setText("message: " + this.getString(R.string.not_receive_info_err));
    ...
    protected void onPaymentSucces() {
        BookingTask bookingTask = new BookingTask(PaymentActivity.this, bookingRes);
        bookingTask.execute();
        new AlertDialog.Builder(PaymentActivity.this)
